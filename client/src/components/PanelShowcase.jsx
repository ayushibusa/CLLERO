...
const panels = [
  {
    ...
    video: '/src/assets/videos/08-panel-owner.mp4',
    accent: '#FF6B35',
  },
  {
    role: 'Trainer',
    ...
    video: '/src/assets/videos/09-panel-trainer.mp4',
    accent: '#4ECDC4',
  },
  {
    role: 'Member',
    ...
    video: '/src/assets/videos/10-panel-member.mp4',
    accent: '#A29BFE',
  },
  {
    role: 'Dietitian',
    ...
    video: '/src/assets/videos/11-panel-dietitian.mp4',
    accent: '#55EFC4',
  },
];
